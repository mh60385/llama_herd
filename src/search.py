...
class SearchManager:
    def __init__(self, settings: Settings | None = None, max_results: int = 5) -> None:
    ...
    def _enabled_backends(self):
        ...
        if self.settings.crossref_mailto and "example.com" not in self.settings.crossref_mailto:
    ...
    def _search_crossref(self, query: str) -> list[SearchResult]:
        params = {"query": query, "rows": self.max_results, "mailto": self.settings.crossref_mailto}
